...
from .views import get_status, search_articles_view, summarize_article_json_view, summarize_article_file_view, format_text_view
...
urlpatterns = [
    ...
    path('writer/', format_text_view, name='format_text_view'),
]